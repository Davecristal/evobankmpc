...
# ============================================================================
parser = argparse.ArgumentParser(description='EvoBank-MPC with adaptive bank (MLP disabled)')
...
# Unknown friction-change detector parameters
...
# Planning and cost function parameters
...
# Adaptive lateral error penalty
...
# Unknown friction-change detector parameters (continued)
...
# new version (not used in final, kept for compatibility)
...
# ============================================================================
# Track selection and friction change setup
# ----------------------------------------------------------------------------
# 1: ETHZ
# TRACK_NAME = 'ETHZ'
# SIM_TIME = 36.0
...
# PROJIDX_THRESHOLD = 656   # raceline
